...
const Sidebar = () => {
    ...
    const menuItems = [
        { path: '/admin/dashboard', label: 'Dashboard', icon: <LayoutDashboard size={24} /> },
        { path: '/admin/pending-clubs', label: 'Pending Clubs', icon: <Clock size={24} /> },
        { path: '/admin/clubs', label: 'All Clubs', icon: <Users size={24} /> },
        { path: '/admin/events', label: 'All Events', icon: <Calendar size={24} /> },
    ];
        ...
        <header className="bg-card border-b border-border px-4 lg:px-6 py-3 sticky top-0 z-30">
            <div className="flex items-center justify-between">
                ...
                <div className="hidden lg:block">
                    ...
                    <p className="text-sm text-muted-foreground">Manage clubs and events</p>
                </div>
